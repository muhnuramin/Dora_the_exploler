                ...
                <form action="<?= base_url('home/tambahData') ?>" method="POST" enctype="multipart/form-data">
                    <div class="row my-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" placeholder="berita_judul" name="berita_judul" id="berita_judul">
                        </div>
                        <div class="col">
                            <label for="berita_deskripsi"><b>berita_deskripsi</b></label>
                            <input type="text" class="form-control" placeholder="berita_deskripsi" name="berita_deskripsi" id="berita_deskripsi">
                        </div>
                    </div>
                    <div class="row my-3">
                        <div class="col">
                            <label for="berita_tgl"><b>berita_tgl</b></label>
                            <input type="text" class="form-control" placeholder="berita_tgl" name="berita_tgl" id="berita_tgl">
                        </div>
                        <div class="col">
                            <label for="berita_autor"><b>berita_autor</b></label>
                            <input type="text" class="form-control" placeholder="berita_autor" name="berita_autor" id="berita_autor">
                        </div>
                    </div>
                    <div class="row my-3">
                        <div class="col">
