<div class="container-fluid">
    <?php foreach ($surat_masuk as $s) : ?>
        <a href="<?= base_url('bidang5/print/'); ?><?= $s->id_disposisi ?>" target="_BLANK" type="button" class="btn btn-success"><i class="fas fa-print"></i> Print Lembar Disposisi</a><br><br>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <?php if (file_exists('./' . $s->catatan)) { ?>
                                    <div><img src="<?= base_url() ?><?= $s->catatan ?>"></div>
                                <?php } else { ?>
                                    <p><?= $s->catatan ?></p>
                                <?php } ?>
                            </td>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <?php if (file_exists('./' . $s->catatan_bidang)) { ?>
                                    <div><img src="<?= base_url() ?><?= $s->catatan_bidang ?>"></div>
                                <?php } else { ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="collapse show" id="previewSurat2">
            <div class="card-body">
                <form method="POST" action="<?= base_url('bidang5/catatan'); ?>">
